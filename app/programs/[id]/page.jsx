            ...
            <div className="max-w-7xl mx-auto px-4 py-20 lg:py-28 grid grid-cols-1 lg:grid-cols-3 gap-10">
                ...
                <div className="lg:col-span-2 space-y-20">
                    ...
                    <section id="curriculum">
                        <h2 className="text-3xl font-bold text-slate-900 mb-6 flex items-center gap-3">
                            <span className="w-2 h-8 bg-blue-600 rounded-full"></span> Curriculum Highlights
                        </h2>
                                ...
                                <table className="w-full text-left border-collapse">
                                    <thead>
                                        <tr className="bg-slate-50 border-b border-slate-100">
                                            <th className="p-4 font-bold text-slate-900 w-1/4">Semester</th>
                                            <th className="p-4 font-bold text-slate-900">Key Subjects</th>
                                        </tr>
                                    </thead>
                                                ...
                                                <td className="p-4">
                                                    <div className="flex flex-wrap gap-2">
                                                        {item.subjects.map((sub, sIdx) => (
                                                            <span key={sIdx} className="inline-block px-2.5 py-1 bg-slate-100 text-slate-600 text-xs font-bold rounded border border-slate-200">
                                                                {sub}
                                                            </span>
                                                        ))}
                                                    </div>
                ...
                <div className="lg:col-span-1">
                    <div className="sticky top-24 space-y-8">
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
                            <h3 className="font-bold text-slate-900 mb-4 text-lg">Quick Facts</h3>
                            <div className="space-y-4">
                                {keyFacts.map((fact, idx) => (
                                    <div key={idx} className="flex items-center justify-between pb-3 border-b border-slate-50 last:border-0 last:pb-0">
                                        ...
                                        <span className="font-bold text-slate-900 text-sm">{fact.value}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
