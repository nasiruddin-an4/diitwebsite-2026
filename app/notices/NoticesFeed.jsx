...
const NoticesFeed = ({ initialNotices }) => {
  ...
  // No longer need client-side loading checks

  return (
    <div className="min-h-screen bg-slate-50 pb-20">
      {/* Hero Section */}
      <div className="bg-[#001229] pt-14 md:pt-24 pb-14 px-4  relative overflow-hidden">
        <div className="max-w-6xl mx-auto text-center relative z-10">
          <motion.div
            ...
            className="mb-6"
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-amber-300 text-sm font-medium">
            ...
            <p className="text-blue-100/70 text-lg max-w-2xl mx-auto leading-relaxed line-clamp-3">
      ...
      <div className="container mx-auto px-4 md:px-4 lg:px-6 relative z-10 -mt-10">
        <div className="grid md:grid-cols-[1fr_320px] gap-8 items-start">
                  ...
                  <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-lg mb-6 space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <button
                        ...
                        className="text-xs text-brandColor font-bold"
                      >
                        Close
                      </button>
                    </div>
                ...
                paginatedNotices.map((notice) => (
                  ...
                  >
                    ...
                    >
                      ...
                      {notice.image ? (
                        <div className="w-16 h-16 sm:w-24 sm:h-24 bg-slate-100 rounded-xl overflow-hidden shrink-0 border border-slate-200 relative">
                          <img
                            src={notice.image}
                            alt="Thumbnail"
                        ...
                        <div className="flex flex-col items-center justify-center w-16 h-16 sm:w-24 sm:h-24 bg-slate-50 rounded-xl border border-slate-100 shrink-0 group-hover:bg-blue-50 group-hover:border-blue-100 transition-colors">
                          <span className="text-lg sm:text-2xl font-bold text-slate-700 group-hover:text-blue-600">
                      ...
                      <div className="flex-1 min-w-0 py-1">
                        <div className="flex items-start justify-between gap-4 mb-2">
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            <span
                              className={`px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider border ${getCategoryColor(notice.category)}`}
                            >
                              {notice.category}
                            </span>
                            {notice.department &&
                              notice.department !== "All" && (
                                <span
                                  className={`px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider border ${getDepartmentColor(notice.department)}`}
                                >
                                  {notice.department}
                                </span>
                              )}
          ...
          <div className="space-y-6 md:sticky md:top-24 h-fit hidden md:block">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-lg shadow-slate-200/50">
              <h3 className="font-bold text-slate-800 mb-4 flex items-center gap-2">
                <GraduationCap className="w-5 h-5 text-indigo-500" /> Filter by
                Department
              </h3>
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-lg shadow-slate-200/50">
              <h3 className="font-bold text-slate-800 mb-4 flex items-center gap-2">
                <Filter className="w-5 h-5 text-brandColor" /> Filter by
                Category
              </h3>
              <div className="space-y-2">
                {categories.map((cat) => (
