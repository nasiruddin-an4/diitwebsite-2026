...
const TestimonialsSection = () => {
    ...
    const TestimonialCard = ({ testimonial }) => (
        <div className="bg-white rounded-2xl p-6 mb-5 shadow-lg shadow-gray-200/50 border border-gray-100">
        ...
        <section className="py-20 bg-slate-50 relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
                    {/* Left Side - Title */}
                    <div className="lg:w-[350px] flex-shrink-0 lg:sticky lg:top-20 lg:self-start">
                    ...
                    <div className="flex-1 relative h-[550px] overflow-hidden">
                        {/* Gradient Overlays */}
