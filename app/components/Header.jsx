...
const fallbackNavigationItems = [
  ...
  },
  {
    ...
    dropdown: [
      ...
      {
        name: "NU Notices",
        path: "https://www.nu.ac.bd/recent-news-notice.php",
        target: "_blank",
        external: true,
      },
  ...
  },
  {
    ...
    dropdown: [
      ...
      {
        name: "BBA in Tourism and Hospitality Management",
        path: "/programs/bthm",
      },
      {
    ...
    <>
      ...
      >
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 h-full flex items-center justify-between">
          ...
          <Link
            href="/"
            className="flex items-center group relative z-50 mr-8 lg:mr-12"
          >
          ...
          <nav className="hidden xl:flex items-center gap-8 ml-auto mr-6">
            {navigationItems.map((item) => (
              ...
              >
                <Link
                  href={item.path || "#"}
                  className={`relative z-10 py-2 text-[18px] font-semibold transition-colors duration-200 flex items-center gap-1.5 ${
              ...
              <div className="bg-white rounded-2xl shadow-2xl overflow-hidden ring-1 ring-black/10">
                    ...
                    {isSearching ? (
                      ...
                      <div className="p-8 text-center">
                        ...
                        <p className="text-slate-400 text-sm mt-1">
                          Try different keywords or browse our quick links below
                        </p>
                      </div>
                    )}
                  </div>
                ...
                {searchQuery.length < 2 && (
                  <div className="p-4 bg-slate-50 text-sm text-slate-500 font-medium">
                    <div className="px-2 pb-2 text-xs uppercase tracking-wider text-slate-400">
                      Quick Links
                    </div>
                    ...
                    <div className="mt-3 pt-3 border-t border-slate-200 text-xs text-slate-400 text-center">
                      Type to search • Use ↑↓ to navigate • Press Enter to
                      select
                    </div>
                  </div>
                )}
